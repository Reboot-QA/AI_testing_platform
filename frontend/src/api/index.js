...
function shouldSuppress401Toast(error) {
...
export const apifoxApi = {
  ...
  listEnvServers: (eid) => request.get(`/apifox/environments/${eid}/servers`),
  createEnvServer: (eid, data) => request.post(`/apifox/environments/${eid}/servers`, data),
  updateEnvServer: (sid, data) => request.put(`/apifox/environment-servers/${sid}`, data),
  deleteEnvServer: (sid) => request.delete(`/apifox/environment-servers/${sid}`),
