  ...
  <div class="schema-manage">
    <div class="list-panel">
      <div class="panel-head">
        ...
        <el-button type="primary" size="small" @click="addSchema">
...
import { DESC_MAX_LEN, MODEL_NAME_MAX_LEN, SEARCH_MAX_LEN } from '@/constants/limits'
...
import SchemaFieldRow from '@/components/apifox/editors/SchemaFieldRow.vue'
