...
from app.routers.apifox import import_schedules_router as apifox_import_schedules_router
...
from app.routers.apifox import sql_scripts_router as apifox_sql_scripts_router
from app.routers.apifox import suites_router as apifox_suites_router
from app.routers.apifox import trash_router as apifox_trash_router
...
# separate_input_output_schemas=False：固定不拆分 Xxx-Input/-Output，使不同 fastapi 版本导出的
# openapi 一致（前端裸用 Schemas['CaseCreate'] 等），消除 schema.d.ts 版本漂移。
app = FastAPI(
