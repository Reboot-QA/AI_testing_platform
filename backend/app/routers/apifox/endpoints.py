...
from app.services.apifox.default_headers import DEFAULT_HEADERS
...
@router.get("/default-headers", response_model=List[DefaultHeaderOut])
def list_default_headers(_: User = Depends(get_current_user)):
    """自动生成的默认请求头清单（静态配置，单一事实来源在后端）。"""
