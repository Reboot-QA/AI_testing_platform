...
from app.constants.limits import DESC_MAX_LEN, MODEL_NAME_MAX_LEN


class SchemaCreate(BaseModel):
    name: str = Field(min_length=1, max_length=MODEL_NAME_MAX_LEN)
    json_schema: str = "{}"
    description: Optional[str] = Field(default=None, max_length=DESC_MAX_LEN)


class SchemaUpdate(BaseModel):
    name: Optional[str] = Field(default=None, min_length=1, max_length=MODEL_NAME_MAX_LEN)
